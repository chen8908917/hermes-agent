...
_TOOLS = (
    ...
    ("security_record_attack_path", SECURITY_RECORD_ATTACK_PATH_SCHEMA, handle_record_attack_path),
    ("security_rank_attack_paths", SECURITY_RANK_ATTACK_PATHS_SCHEMA, handle_rank_attack_paths),
    ("security_select_attack_path", SECURITY_SELECT_ATTACK_PATH_SCHEMA, handle_select_attack_path),
    ("security_update_attack_path", SECURITY_UPDATE_ATTACK_PATH_SCHEMA, handle_update_attack_path),
