...
def test_security_plugin_registers_tools():
    ...
    assert "security_record_attack_path" in registry.get_all_tool_names()
    assert "security_rank_attack_paths" in registry.get_all_tool_names()
    assert "security_select_attack_path" in registry.get_all_tool_names()
    assert "security_update_attack_path" in registry.get_all_tool_names()
