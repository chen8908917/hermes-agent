...
$RepoUrlSsh = "git@github.com:chen8908917/hermes-agent.git"
$RepoUrlHttps = "https://github.com/chen8908917/hermes-agent.git"
$PythonVersion = "3.11"
$NodeVersion = "22"
...
function Install-Repository {
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                $zipUrl = "https://github.com/chen8908917/hermes-agent/archive/refs/heads/$Branch.zip"
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/chen8908917/hermes-agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
